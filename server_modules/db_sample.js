...
if (module === require.main) {
  ...
  prompt.get(['user', 'password'], (err, result) => {
    ...
    connection.query(
      ...
      'INSERT INTO attendance(attendance_id, course_id, student_id, lesson_id, attendance, att_date ) VALUES ' +
      '(1,  1, 001, 1 , 1, \'28-08-2018\'),'+
      '(2,  1, 001, 2 , 1, \'05-09-2018\'),'+
      '(3,  1, 001, 3 , 1, \'12-09-2018\'),'+
      '(4,  1, 001, 4 , 0, \'19-09-2018\'),'+
      '(5,  1, 001, 5 , 0, \'26-09-2018\'),'+

      '(6,  1, 002, 1 , 1, \'02-06-2018\'),'+
      '(7,  1, 002, 2 , 1, \'09-06-2018\'),'+
      '(8,  1, 002, 3 , 1, \'16-06-2018\'),'+
      '(9,  2, 002, 4 , 1, \'23-06-2018\'),'+
      '(10, 2, 002, 5 , 0, \'30-06-2018\'),'+

      '(11, 1, 003, 1 , 1, \'28-08-2018\'),'+
      '(12, 1, 003, 2 , 1, \'05-09-2018\'),'+
      '(13, 1, 003, 3 , 1, \'12-09-2018\'),'+
      '(14, 1, 003, 4 , 0, \'19-09-2018\'),'+
      '(15, 1, 003, 5 , 0, \'26-09-2018\'),'+

      '(16, 3, 004, 1 , 1, \'22-10-2017\'),'+
      '(17, 3, 004, 2 , 1, \'29-10-2017\'),'+
      '(18, 3, 005, 3 , 1, \'05-11-2017\'),'+
      '(19, 3, 005, 4 , 1, \'12-11-2017\'),'+
      '(20, 3, 005, 5 , 1, \'19-11-2017\'),'+

      '(21, 4, 005, 1 , 1, \'17-12-2018\'),'+
      '(22, 4, 005, 2 , 0, \'24-12-2018\'),'+
      '(23, 4, 005, 3 , 0, \'31-12-2018\'),'+
      '(24, 4, 005, 4 , 0, \'07-01-2019\'),'+
      '(25, 4, 005, 5 , 0, \'14-01-2019\');'
