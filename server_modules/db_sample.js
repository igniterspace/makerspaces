...
if (module === require.main) {
  ...
  prompt.get(['user', 'password'], (err, result) => {
    ...
    connection.query(
      ...
      '(2, 1, 1, \'2016-01-14 05:52:02\' , \'2014-05-25 05:30:50\' ),'+
      '(3, 2, 2, \'2014-02-26 10:33:03\' , \'2015-02-28 08:30:00\' ),'+
      '(4, 2, 2, \'2016-02-26 11:34:04\' , \'2016-02-28 08:30:00\' ),'+
      '(5, 3, 3, \'2017-02-26 12:35:05\' , \'2017-02-28 08:30:00\' ),'+
      '(6, 3, 3, \'2017-02-26 14:36:06\' , \'2017-02-28 08:30:00\' );' +
      ...
      'INSERT INTO attendance(attendance_id, location_id, course_id, student_id, lesson_id, attendance_mark, att_date ) VALUES ' +
      '(1, 1,  1, 001, 1 , 1, \'28-08-2018\'),'+
      '(2, 1, 1, 001, 2 , 1, \'05-09-2018\'),'+
      '(3, 1, 1, 001, 3 , 0, \'\'),'+
      '(4, 1, 1, 001, 4 , 0, \'\'),'+
      '(5, 1, 1, 001, 5 , 0, \'\'),'+

      '(6, 1, 1, 002, 1 , 1, \'02-06-2018\'),'+
      '(7, 1, 1, 002, 2 , 0, \'09-06-2018\'),'+
      '(8, 1, 1, 002, 3 , 1, \'16-06-2018\'),'+
      '(9, 1, 1, 002, 4 , 0, \'23-06-2018\'),'+
      '(10,1, 1, 002, 5 , 0, \'\'),'+

      '(11, 1, 2, 001, 1 , 1, \'28-08-2018\'),'+
      '(12, 1,2, 001, 2 , 1, \'05-09-2018\'),'+
      '(13, 1, 2, 001, 3 , 1, \'12-09-2018\'),'+
      '(14, 1, 2, 001, 4 , 0, \'\'),'+
  
      '(16, 1, 3, 003, 1 , 1, \'22-10-2017\'),'+
      '(17, 1, 3, 003, 2 , 0, \'29-10-2017\'),'+
      '(18, 1, 3, 003, 3 , 1, \'05-11-2017\'),'+

      '(21, 1, 4, 004, 1 , 1, \'17-12-2018\'),'+
      '(22, 1, 4, 004, 2 , 0, \'\'),'+
